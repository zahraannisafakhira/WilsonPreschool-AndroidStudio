...
public class ContactFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mName = view.findViewById(R.id.nameCon);
        mEmail = view.findViewById(R.id.emailCon);
        mSubject = view.findViewById(R.id.subjectCon);
        mMessage = view.findViewById(R.id.descriptionCon);
